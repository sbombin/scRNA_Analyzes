...
object_1 <- Read10X(data.dir = "filtered_feature_bc_matrix_1/")
...
##My filtering
object_1 <- subset(object_1 , subset = CXCL12 > 0.01 | CD36 > 0.01)
##
...
object_2 <- Read10X(data.dir = "filtered_feature_bc_matrix_2/")
...
##My filtering
object_2 <- subset(object_2 , subset = CXCL12 > 0.01 | CD36 > 0.01)
##
...
object_3 <- Read10X(data.dir = "filtered_feature_bc_matrix_3/")
...
##My filtering
object_3 <- subset(object_3 , subset = CXCL12 > 0.01 | CD36 > 0.01)
##
...
object_4 <- Read10X(data.dir = "filtered_feature_bc_matrix_4/")
...
object_5 <- Read10X(data.dir = "filtered_feature_bc_matrix_5/")
...
object_6 <- Read10X(data.dir = "filtered_feature_bc_matrix_6/")
...
object_7 <- Read10X(data.dir = "filtered_feature_bc_matrix_7/")
...
object_8 <- Read10X(data.dir = "filtered_feature_bc_matrix_8/")
...
object_9 <- Read10X(data.dir = "filtered_feature_bc_matrix_9/")
...
object_10 <- Read10X(data.dir = "filtered_feature_bc_matrix_10/")
...
object_11 <- Read10X(data.dir = "filtered_feature_bc_matrix_30/")
...
object_12 <- Read10X(data.dir = "filtered_feature_bc_matrix_32/")
...
object_13 <- Read10X(data.dir = "filtered_feature_bc_matrix_31/")
...
object_14 <- Read10X(data.dir = "filtered_feature_bc_matrix_27/")
...
object_15 <- Read10X(data.dir = "filtered_feature_bc_matrix_28/")
...
object_16 <- Read10X(data.dir = "filtered_feature_bc_matrix_36/")
...
object_17 <- Read10X(data.dir = "filtered_feature_bc_matrix_37/")
...
object_18 <- Read10X(data.dir = "filtered_feature_bc_matrix_38/")
...
object_19 <- Read10X(data.dir = "filtered_feature_bc_matrix_39/")
...
object_20 <- Read10X(data.dir = "filtered_feature_bc_matrix_40/")
